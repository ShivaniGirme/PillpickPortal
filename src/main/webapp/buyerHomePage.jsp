                        ...
                        <!-- <li><a title="Contact" href="#">Services<span></span></a></li> -->
						  ...
						  <div class="dropdown">
							...
							<div class="dropdown-content">
							  ...
							  <a href="homeopathicProduct.jsp">Homeopathic</a>
							</div>
						  </div>
			...
			<div id="slider-holder">
				<div class="shell">
					...
					<div id="slider">
						...
						<div id="slider-nav">
							<a title="medicine" href="#">1<span class="fade"></span><span class="active"></span><img src="css/images/medicine.jpg" alt="medicine.jpg" /></a>
							<a title="consult doctor" href="#">2<span class="fade"></span><span class="active"></span><img src="css/images/doctor.jpg" alt="doctor.jpg" /></a>
							<a title="take lab test" href="#">3<span class="fade"></span><span class="active"></span><img src="css/images/Labtest.jpg" alt="Labtest.jpg" /></a>
						</div>						
					</div>
					<!-- END Main Slider -->								
				</div>	
